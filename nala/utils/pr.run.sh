...
npx playwright test --config=./playwright.config.js ${TAGS} ${EXCLUDE_TAGS} --project=dc-live-chromium --project=dc-live-firefox --project=dc-live-webkit ${REPORTER} || EXIT_STATUS=$?
